...
const ShortsMining = ({ data, metadata }) => {
  console.log('📊 ShortsMining data:', data)
  ...
  const info = moduleInfo['ShortsMining'] || { icon: '📊', title: 'ShortsMining', desc: 'Analysis Module' }
