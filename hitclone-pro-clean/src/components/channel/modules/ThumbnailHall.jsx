...
const ThumbnailHall = ({ data, metadata }) => {
  console.log('📊 ThumbnailHall data:', data)
  ...
  const info = moduleInfo['ThumbnailHall'] || { icon: '📊', title: 'ThumbnailHall', desc: 'Analysis Module' }
